...
import noesis.model.random.WattsStrogatzSmallWorldNetwork;
...
public class WattsStrogatzNetworkUI extends NewNetworkUI 
{
	...
	public class WattsStrogatzNetworkAction extends Action 
	{
		...
		public void run() 
		{
			...
			WattsStrogatzSmallWorldNetwork random = new WattsStrogatzSmallWorldNetwork(nodes, neighbors, rewiringProbability);
			AttributeNetwork network = createAttributeNetwork(random, "Gilbert random network", new CircularLayout ());			
