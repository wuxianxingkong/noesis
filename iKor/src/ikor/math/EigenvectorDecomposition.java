...
/** 
 * Eigenvalues and eigenvectors of a real matrix, adapted from JAMA (http://math.nist.gov/javanumerics/jama/).
 * <p>
 *     From the JAMA documentation:
 * <p>
 *     If A is symmetric, then A = V*D*V' where the eigenvalue matrix D is
 *     diagonal and the eigenvector matrix V is orthogonal.
 *     i.e. A = V.multiply(D.multiply(V.transpose())) and V.multiply(V.transpose()) equals the identity matrix.
 * <p>
...
public class EigenvectorDecomposition 
{
	...
	public EigenvectorDecomposition (Matrix matrix) 
	{
		...
		eigenvectors = new DenseMatrix(V);
	}
	...
	/**
	 * Return a particular eigenvector.
	 * @param n Eigenvector number
	 * @return Eigenvector
	 */
	public Vector getEigenvector (int n)
	{
		return eigenvectors.getColumn(n);
	}
	...
	/**
	 * Return the real part of a particular eigenvalue.
	 * @param n Eigenvalue number
	 * @return Real part of the desired eigenvalue
	 */
	...
	/**
	 * Return the imaginary part of a particular eigenvalue.
	 * @param n Eigenvalue number
	 * @return Imaginary part of the desired eigenvalue
	 */
