...
// Adapted from "Core Web Programming"
//              Prentice Hall Publishers
//              1997 Marty Hall, hall@apl.jhu.edu.
  ...
  private static boolean exec(String command,
    ...
    try {
      ...
      if(printResults) {
        ...
        // Deprecated: DataInputStream commandResult = new DataInputStream(buffer);
        String s = null;
        try {
