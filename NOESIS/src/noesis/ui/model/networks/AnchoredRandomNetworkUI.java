...
public class AnchoredRandomNetworkUI extends NewNetworkUI 
{
	...
	public class AnchoredRandomNetworkAction extends Action 
	{
		...
		public void run() 
		{
			...
			AttributeNetwork network = createAttributeNetwork(random, "Anchored random network", new RandomLayout ());
